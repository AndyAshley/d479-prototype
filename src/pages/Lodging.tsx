    ...
    <Container fluid className="pt-5 px-0">
      <Container className="pb-5">
        ...
        <p>
          ...
          resort, or a rustic cabin, we have something for everyone. Our lodging
          options are as diverse as our landscapes, so you can choose the
          perfect place to relax and unwind after a day of adventure. Check out
          the guides below for the best places to stay on Taniti, each offering
          something special to make your stay memorable.
        </p>
      </Container>
      <Container
        fluid
